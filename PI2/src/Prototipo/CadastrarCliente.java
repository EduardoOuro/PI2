...
public class CadastrarCliente extends javax.swing.JFrame {
    ...
    descNomeCli = (campoNomeCliente.getText());
    descCPF = (campoCpfCliente.getText());
    descEndereco = (campoEnderecoC.getText());
    descNumeroCasa = Integer.parseInt(campoEnderecoC1.getText());
    descComplemento = (campoEnderecoC2.getText());
    descCidade = (campoCidadeCliente.getText());
    descUF = (comboUfC.getActionCommand());
    descTelefone = (campoTelefoneC.getText());
    
    controller.salvarCli(descNomeCli,descCPF,descEndereco,descNumeroCasa,descComplemento,descCidade,descUF,descTelefone);
        refreshTable();
